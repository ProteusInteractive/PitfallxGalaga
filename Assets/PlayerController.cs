...
public class PlayerController : MonoBehaviour
{
    ...
    //    Vector3 newPos = new Vector3(player.transform.position.x + xMove, player.transform.position.y, player.transform.position.z + zMove);

    //    //check player position inside the bounding box
    //    //if ()
    //    //{
    //    //    if (zmin < newZPos && newZPos < zmax)
    //    //    {
    //    //        player.transform.Translate(xMove, 0, zMove);
    //    //    }
    //    //}
    //}
}
